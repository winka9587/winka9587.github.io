...
summary: 
image:
    path: /assets/img/2025-09-22-16-45-11.png
---
...
https://www.kaggle.com/competitions/rsna-intracranial-aneurysm-detection/discussion/600540#3273846

masks are packed y,x,z(z对应的是DICOM图像中的序号)


> Thanks for your question. The aneurysm coordinates in the spreadsheet are just a single point approximating the center of the aneurysm. As such there is only a single point per aneurysm, which is a single x, y coordinate plus a slice instance, which is the z coordinate. For a subset of 3D DICOM data in the dataset, we also provide a frame number, which is the equivalent of a z coordinate. Hope this helps! (from https://www.kaggle.com/competitions/rsna-intracranial-aneurysm-detection/discussion/606892#3287113
)
